...
export TOMCAT_VERSION="apache-tomcat-8.5.59"
export SERVER_HOME=/usr/local
export CATALINA_HOME=${SERVER_HOME}/${TOMCAT_VERSION}
export SERVER_NAME=${HOSTNAME}
export CATALINA_BASE=${CATALINA_HOME}
export LOG_HOME=${CATALINA_BASE}/logs

export LD_LIBRARY_PATH=${CATALINA_HOME}/lib:${LD_LIBRARY_PATH}
export CLASSPATH=${CLASSPATH}:${SERVER_HOME}/${TOMCAT_VERSION}/lib
...
JAVA_OPTS="${JAVA_OPTS} -Xloggc:${LOG_HOME}/gclog/${SERVER_NAME}_gc.log_${DATE}"
...
#JAVA_OPTS="${JAVA_OPTS} -XX:CompileCommand='print, *.*'"
